...
public:
    ...
    * @param r The new rotation angle in radians
	...
	/**
	 * Function to update properties about the drawable implemented by user
	 * Most drawables do not have the capabilities to open a dialog box, but machine drawable will override
	 * @param parent
	 */
	virtual void ShowDialog(wxWindow* parent) {}
};
