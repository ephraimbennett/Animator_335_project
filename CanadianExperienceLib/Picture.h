...
private:
	...
	/// pointer to the machine drawable for saving purposes
...
public:
    ...
    */
	...
	/**
	 * Sets the machine drawable for the picture
	 * @param mDrawable
	 */
	void SetMachineDrawable(std::shared_ptr<MachineDrawable> mDrawable) {mMachineDrawable = mDrawable;}
